...
export interface paths {
    ...
    "/api/agent/runs/lookup": {
        ...
        /** Lookup Run */
        get: operations["lookup_run_api_agent_runs_lookup_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/agent/sessions/{conversation_id}/runs/latest": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Latest Run */
        get: operations["latest_run_api_agent_sessions__conversation_id__runs_latest_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/agent/runs/{run_id}/events": {
        ...
        /** Get Run Events */
        get: operations["get_run_events_api_agent_runs__run_id__events_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/agent/runs/{run_id}/stream": {
        ...
        /** Stream Run */
        get: operations["stream_run_api_agent_runs__run_id__stream_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/agent/runs/{run_id}/cancel": {
        ...
        put?: never;
        /** Cancel Run */
        post: operations["cancel_run_api_agent_runs__run_id__cancel_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/workflow/series": {
        ...
        /** List Series */
        get: operations["list_series_api_workflow_series_get"];
        put?: never;
        /** Create Series */
    ...
    "/api/workflow/series/{series_id}": {
        ...
        /** Get Series */
        get: operations["get_series_api_workflow_series__series_id__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/workflow/episodes": {
        ...
        /** List Episodes */
        get: operations["list_episodes_api_workflow_episodes_get"];
        put?: never;
        /** Create Episode */
    ...
    "/api/workflow/episodes/{episode_id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Get Episode */
        get: operations["get_episode_api_workflow_episodes__episode_id__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/production/documents": {
        ...
        /** List Documents */
        get: operations["list_documents_api_production_documents_get"];
        put?: never;
        /** Create Document */
...
export interface operations {
    ...
    lookup_run_api_agent_runs_lookup_get: {
        parameters: {
            query: {
                conversation_id: string;
                request_id: string;
    ...
    latest_run_api_agent_sessions__conversation_id__runs_latest_get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["AgentRunRead"] | null;
                };
            };
            /** @description Validation Error */
            422: {
    ...
    get_run_events_api_agent_runs__run_id__events_get: {
        parameters: {
            query?: {
                after_seq?: number;
            };
    ...
    stream_run_api_agent_runs__run_id__stream_get: {
        parameters: {
            query?: {
                after_seq?: number;
            };
    ...
    cancel_run_api_agent_runs__run_id__cancel_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    list_series_api_workflow_series_get: {
        parameters: {
            query: {
                project_id: string;
                limit?: number;
    ...
    get_series_api_workflow_series__series_id__get: {
        parameters: {
            query: {
                project_id: string;
            };
    ...
    list_episodes_api_workflow_episodes_get: {
        parameters: {
            query: {
                project_id: string;
                series_id: string;
    ...
    get_episode_api_workflow_episodes__episode_id__get: {
        parameters: {
            query: {
                project_id: string;
                series_id: string;
    ...
    list_documents_api_production_documents_get: {
        parameters: {
            query: {
                project_id: string;
                episode_id: string;
