...
revisions, semantic snapshots, diffs, and stale dependencies. `app.production` owns only document
...
immediately preceding document. Artifact dependencies retain that source revision. Editing a selected
